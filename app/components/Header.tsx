...
export default function Header() {
  ...
  return (
    <header className="bg-white fixed inset-x-0 top-0 z-50">
      <nav className="mx-auto flex items-center justify-between pt-4 4xl:pt-6 pb-4 4xl:pb-6 px-8 md:px-18 lg:px-28 2xl:px-38 3xl:px-[250px] 4xl:px-[400px] 5xl:px-[600px]" aria-label="Global">
