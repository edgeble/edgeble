...
const ProductCard: React.FC<ProductCardProps> = ({ image, title, description, specs }) => (
  <div className="flex flex-col overflow-hidden">
    ...
    <div className="pt-4">
      <h3 className="py-2 lg:py-3 3xl:py-4 4xl:py-5 text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl font-semibold mb-2">{title}</h3>
      <p className="text-sm md:text-md xl:text-lg 2xl:text-xl 3xl:text-2xl 4xl:text-3xl pb-2 lg:pb-3 3xl:pb-4 4xl:pb-5">{description}</p>
