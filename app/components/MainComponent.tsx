...
const MainComponent = () => {
  ...
  return (
    ...
    <div className="w-full h-auto flex flex-col justify-center items-start py-6 md:py-10 lg:py-14 2xl:py-20 3xl:py-28 px-8 md:px-18 lg:px-28 2xl:px-38 3xl:px-[250px] 4xl:px-[400px] 5xl:px-[600px] relative isolate">
