...
const MainComponent = () => {
  ...
  return (
    ...
    <p className="text-xl md:text-3xl lg:text-4xl xl:text-5xl mb-4 lg:mb-12 xl:mb-16 2xl:mb-16 text-left">Burgeoning Edge AI</p>
  ...
  <div className="order-1 lg:order-2 w-full lg:w-1/4 grid grid-cols-2 gap-4">
    {cardData.map((card) => (
