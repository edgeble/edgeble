...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white w-screen overflow-x-hidden max-w-full relative box-border">
      ...
      <div
        className="min-h-screen relative isolate px-8 md:px-18 lg:px-28 2xl:px-38 3xl:px-[300px] 4xl:px-[700px] 5xl:px-[900px] pt-14 lg:px-8 flex flex-col"
        style={{
...
<motion.div
    ...
    >
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
        className="mb-6 mb:py-10 lg:mb-14 2xl:mb-20 3xl:mb-28 px-8 md:px-18 lg:px-28 2xl:px-38 3xl:px-[300px] 4xl:px-[700px] 5xl:px-[900px] box-border"
      >
      ...
      >
        <div className="flex flex-col md:w-3/4 items-center md:items-start">
          ...
          <p className="text-white text-sm md:text-md lg:text-lg xl:text-xl 2xl:text-2xl 4xl:text-3xl pt-2 tracking-wide leading-normal text-center md:text-left">
            Mission on deploying High Performance Ultra-Vision AI Accelerators
            at the Edge
          </p>
        </div>
